...
const I18N = (function () {
  const dict = {
    ar: {
      ...
      "services.aiT": "أتمتة الذكاء الاصطناعي",
      "services.aiS": "AI Automation",
      "services.ai1": "تدفقات عمل وذكاء اصطناعي",
      "services.ai2": "أتمتة المهام المتكررة",
      "services.ai3": "روبوتات ومساعدات ذكية",
      ...
      "auth.loginSubtitle": "ادخل لحسابك لتعديل ملفك أو إدارة مستقلّيك.",
      "auth.loginEmail": "البريد الإلكتروني",
      "auth.loginPassword": "كلمة المرور",
      "auth.loginSubmit": "دخول",
      "auth.loginNoAccount": "مش عندك حساب؟",
      "auth.loginSignUpFreelancer": "انضم كمستقل",
      "auth.loginSignUpClient": "سجّل كعميل",
      "auth.loginAdminNote": "للمشرف: بعد الدخول ستنتقل تلقائيًا للوحة التحكم.",
      "auth.loginSuccess": "تم الدخول… جارِ التحويل",
      "auth.loginError": "تعذّر الدخول",
      "auth.loginRedirecting": "جارِ التحويل",
      "auth.signupError": "تعذّر إنشاء الحساب",
      "auth.tryAgain": "جرّب مرة أخرى",

      "dashboard.title": "حسابي",
      "dashboard.logout": "تسجيل الخروج",
      "dashboard.roleFreelancer": "أنت مسجّل كمستقل.",
      "dashboard.roleClient": "أنت مسجّل كعميل.",
      "dashboard.freelancerTitle": "ملف المستقل",
      "dashboard.freelancerSubtitle": "عدّل بياناتك وأضف صور أعمالك.",
      "dashboard.personalPhoto": "الصورة الشخصية",
      "dashboard.fullName": "الاسم الكامل",
      "dashboard.whatsapp": "رقم الواتساب",
      "dashboard.emailReadOnly": "البريد الإلكتروني (للقراءة فقط)",
      "dashboard.specialty": "التخصص",
      "dashboard.approxRate": "الأجر التقريبي (ج.م)",
      "dashboard.skills": "المهارات (افصل بفاصلة)",
      "dashboard.experience": "سنوات الخبرة",
      "dashboard.shortBio": "نبذة قصيرة",
      "dashboard.projects": "مشاريعك وأعمالك",
      "dashboard.addProject": "+ إضافة مشروع",
      "dashboard.addPhotos": "أضف صورًا",
      "dashboard.deleteProject": "حذف المشروع",
      "dashboard.fileHint": "كل مشروع: أضف اسمًا ورابطًا (اختياري) وارفع صوره — الصور تظهر كبيرة وبشكل مجموعات.",
      "dashboard.saveChanges": "حفظ التغييرات",
      "dashboard.viewProfile": "عرض ملفك العام",
      "dashboard.clientTitle": "ملف العميل",
      "dashboard.clientSubtitle": "عدّل بيانات شركتك.",
      "dashboard.company": "الشركة / النشاط",
      "dashboard.taskPreference": "نوع المهام المفضلة",
      "dashboard.noProfileTitle": "لا يوجد ملف بعد",
      "dashboard.noProfileText": "يبدو أن حسابك ليس لديه ملف. تواصل معنا عبر واتساب لربط حسابك.",
      "dashboard.contactViaWhatsapp": "تواصل عبر واتساب",
      "dashboard.deleteImage": "حذف",
      "dashboard.projectName": "اسم المشروع",
      "dashboard.projectLink": "رابط المشروع (اختياري)",
      "dashboard.projectPlaceholder": "مثال: هوية لبراند كوفي",
      "dashboard.projectLinkPlaceholder": "https://example.com",
      "dashboard.profileUnavailable": "معرّف غير صالح.",
      "dashboard.profileNotFound": "لم يتم العثور على هذا المستقل.",
      "dashboard.profileLoading": "جارِ تحميل الملف…",
      "dashboard.profileAbout": "نبذة",
      "dashboard.profileSkills": "المهارات",
      "dashboard.profileProjects": "مشاريعي وأعمالي",
      "dashboard.profileRecommended": "مستقلون موصى بهم",
      "dashboard.profileVisit": "زيارة المشروع ↗",
      "dashboard.profileContact": "تواصل معه عبر واتساب",
      "dashboard.profileNoBio": "لا توجد نبذة بعد.",
      "dashboard.profileNoSkills": "لم تُضف مهارات.",
      "dashboard.profileNoProjects": "لا توجد صور أعمال بعد.",
      "dashboard.profileNoRecommendations": "لا توجد توصيات حالياً.",
      "dashboard.profileProject": "مشروع",
      "dashboard.profileView": "عرض الملف",
      "dashboard.defaultName": "مستقل",
      "dashboard.profilePrompt": "جارِ تحميل الملف…",
      ...
      "niche.ai": "أتمتة الذكاء الاصطناعي",
    ...
    en: {
      ...
      "services.aiT": "AI Automation",
      "services.aiS": "AI Automation",
      "services.ai1": "AI workflows & automation",
      "services.ai2": "Repetitive task automation",
      "services.ai3": "Smart assistants & bots",
      ...
      "footer.talent.ai": "AI automation",
      ...
      "auth.loginSubtitle": "Sign in to manage your profile or your freelancers.",
      "auth.loginEmail": "Email address",
      "auth.loginPassword": "Password",
      "auth.loginSubmit": "Log in",
      "auth.loginNoAccount": "Don't have an account?",
      "auth.loginSignUpFreelancer": "Join as freelancer",
      "auth.loginSignUpClient": "Create client account",
      "auth.loginAdminNote": "For admins: after login you will be redirected to the dashboard.",
      "auth.loginSuccess": "Logged in… redirecting",
      "auth.loginError": "Login failed",
      "auth.loginRedirecting": "Redirecting",
      "auth.signupError": "Account creation failed",
      "auth.tryAgain": "Please try again",

      "dashboard.title": "My account",
      "dashboard.logout": "Log out",
      "dashboard.roleFreelancer": "You are registered as a freelancer.",
      "dashboard.roleClient": "You are registered as a client.",
      "dashboard.freelancerTitle": "Freelancer profile",
      "dashboard.freelancerSubtitle": "Update your details and add your work samples.",
      "dashboard.personalPhoto": "Profile photo",
      "dashboard.fullName": "Full name",
      "dashboard.whatsapp": "WhatsApp number",
      "dashboard.emailReadOnly": "Email address (read only)",
      "dashboard.specialty": "Specialty",
      "dashboard.approxRate": "Approx. rate (EGP)",
      "dashboard.skills": "Skills (separate with commas)",
      "dashboard.experience": "Years of experience",
      "dashboard.shortBio": "Short bio",
      "dashboard.projects": "Your projects and work",
      "dashboard.addProject": "+ Add project",
      "dashboard.addPhotos": "Add photos",
      "dashboard.deleteProject": "Delete project",
      "dashboard.fileHint": "Each project: add a title and optional link, then upload images — photos display large and in groups.",
      "dashboard.saveChanges": "Save changes",
      "dashboard.viewProfile": "View public profile",
      "dashboard.clientTitle": "Client profile",
      "dashboard.clientSubtitle": "Update your company details.",
      "dashboard.company": "Company / business",
      "dashboard.taskPreference": "Preferred task type",
      "dashboard.noProfileTitle": "No profile yet",
      "dashboard.noProfileText": "It looks like your account has no profile yet. Contact us on WhatsApp to link your account.",
      "dashboard.contactViaWhatsapp": "Contact via WhatsApp",
      "dashboard.deleteImage": "Delete",
      "dashboard.projectName": "Project name",
      "dashboard.projectLink": "Project link (optional)",
      "dashboard.projectPlaceholder": "Example: Coffee brand identity",
      "dashboard.projectLinkPlaceholder": "https://example.com",
      "dashboard.profileUnavailable": "Invalid identifier.",
      "dashboard.profileNotFound": "This freelancer was not found.",
      "dashboard.profileLoading": "Loading profile…",
      "dashboard.profileAbout": "About",
      "dashboard.profileSkills": "Skills",
      "dashboard.profileProjects": "My projects and work",
      "dashboard.profileRecommended": "Recommended freelancers",
      "dashboard.profileVisit": "Visit project ↗",
      "dashboard.profileContact": "Contact via WhatsApp",
      "dashboard.profileNoBio": "No bio added yet.",
      "dashboard.profileNoSkills": "No skills added yet.",
      "dashboard.profileNoProjects": "No work photos yet.",
      "dashboard.profileNoRecommendations": "No recommendations yet.",
      "dashboard.profileProject": "Project",
      "dashboard.profileView": "View profile",
      "dashboard.defaultName": "Freelancer",
      "dashboard.profilePrompt": "Loading profile…",
